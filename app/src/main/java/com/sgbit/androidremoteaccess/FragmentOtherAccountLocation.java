 ...
 */
public class FragmentOtherAccountLocation extends Fragment {


    public FragmentOtherAccountLocation() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view= inflater.inflate(R.layout.fragment_other_account_location, container, false);
        //((ActivityNew)getActivity()).getSupportActionBar().setTitle("LOCATION");
